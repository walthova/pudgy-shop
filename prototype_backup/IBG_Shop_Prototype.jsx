 ...
 * 
 * SHOPIFY READY:
 * This component is structured to consume Shopify Storefront API (GraphQL) data.
 * To integrate, replace the 'mockProducts' and 'IBG_SHOP_CONFIG' with live data fetching.
 */
...
const IBGShop = () => {
  ...
  // Replace this with a useEffect that fetches from Shopify Storefront API
  const mockProducts = [
    {
  ...
  // Product Card: Premium Pop Style
  ...
  return (
    <div className="min-h-screen bg-[#F9FBFF] font-['Outfit',sans-serif] text-[#051633] selection:bg-blue-100">
      ...
      {/* Header: Elevated Floating Navbar */}
      ...
      {/* Hero: Premium Gallery Aesthetic */}
      <section className="pt-40 pb-24 px-6 text-center">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-6xl md:text-9xl font-black text-blue-900 tracking-tighter mb-10 leading-[0.9]">
            INSPIRED BY <br />
            <span className="text-blue-600 bg-gradient-to-b from-blue-600 to-blue-400 bg-clip-text text-transparent italic-none uppercase text-black">THE DIVINE.</span>
          </h1>
      ...
      {/* Shopify Integration Section (Admin View Only Concept) */}
        ...
        <div className="max-w-7xl mx-auto px-10 grid lg:grid-cols-2 items-center gap-20">
          <div>
            ...
            <div className="flex items-center gap-8 opacity-40">
              <span className="font-black text-xl tracking-widest">SHOPIFY API</span>
              <span className="w-1.5 h-1.5 rounded-full bg-blue-400" />
              <span className="font-black text-xl tracking-widest">REACT VITE</span>
              <span className="w-1.5 h-1.5 rounded-full bg-blue-400" />
              <span className="font-black text-xl tracking-widest">TAILWIND</span>
            </div>
          </div>
          <div className="relative">
            <div className="aspect-[4/3] bg-gradient-to-br from-blue-600 to-blue-400 rounded-[3rem] p-1 shadow-2xl">
              <div className="w-full h-full bg-blue-950 rounded-[2.8rem] flex flex-col p-10 font-mono text-sm text-blue-300">
                ...
                <p className="ml-16">images(first: 1) {'{'} url {'}'}</p>
                <p className="mt-4 text-green-400">// Ready for Production</p>
              </div>
            </div>
      ...
      {showCart && (
        <div className="fixed inset-0 z-[100] flex justify-end">
          ...
          <div className="relative w-full max-w-lg bg-white h-full shadow-[0_0_100px_rgba(0,0,0,0.1)] flex flex-col rounded-l-[3.5rem] border-l-[12px] border-blue-600 animate-slide-left p-2">
            ...
            <div className="flex-1 overflow-auto px-10 space-y-10 scrollbar-hide py-4">
              {cart.map(item => (
            ...
            <div className="p-10 bg-blue-50/50 rounded-tl-[4rem] border-t-2 border-white">
              ...
              <p className="text-center mt-6 text-[0.5rem] font-black text-blue-900/20 uppercase tracking-[0.3em]">
                Secure Acquisition Powered by Shopify
              </p>
            </div>
          </div>
        </div>
